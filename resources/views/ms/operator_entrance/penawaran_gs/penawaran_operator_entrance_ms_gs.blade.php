    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/ms_penawaran_o_e_gs@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td id="jumlahPeredamDinding" hidden>
                            <?= (((2 * (($_GET['panjangStudio'] / 100) + ($_GET['lebarStudio'] / 100))) + (2 * (($_GET['panjangOperator'] / 100) + ($_GET['lebarOperator'] / 100)))) * ($_GET['tinggi'] / 100)) * $ms->gypsum_standard_ms ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((((2 * (($_GET['panjangStudio'] / 100) + ($_GET['lebarStudio'] / 100))) + (2 * (($_GET['panjangOperator'] / 100) + ($_GET['lebarOperator'] / 100)))) * ($_GET['tinggi'] / 100)) * $ms->gypsum_standard_ms, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= ((($_GET['panjangStudio'] / 100) * ($_GET['lebarStudio'] / 100)) + (($_GET['panjangOperator'] / 100) * ($_GET['lebarOperator'] / 100))) * $ms->gypsum_standard_ms ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['panjangStudio'] / 100) * ($_GET['lebarStudio'] / 100)) + (($_GET['panjangOperator'] / 100) * ($_GET['lebarOperator'] / 100))) * $ms->gypsum_standard_ms, 0, ',', '.') ?>
                        </td>
                    </tr>
