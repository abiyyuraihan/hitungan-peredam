...
<head>
    ...
    <title>Penawaran {{ $p_o_e_ms->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_o_e_ms->nama }} <br>Lokasi :
                                        {{ $p_o_e_ms->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_o_e_ms->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_o_e_ms->foto1) }}"
                                                alt="{{ $p_o_e_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_o_e_ms->foto2) }}"
                                                alt="{{ $p_o_e_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_o_e_ms->foto3) }}"
                                                alt="{{ $p_o_e_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr class="text-end">
                            <th colspan="6">
                                Panjang Studio : <span id="panjangStudioPrint" style="display: none;"></span><input
                                    type="number" name="panjangStudio" id="panjangStudio" style="width: 60px; border: none;"
                                    value="{{ $p_o_e_ms->panjangStudio }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Lebar Studio : <span id="lebarStudioPrint" style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="lebarStudio" id="lebarStudio"
                                    value="{{ $p_o_e_ms->lebarStudio }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Panjang Operator : <span id="panjangOperatorPrint" style="display: none;"></span><input
                                    type="number" name="panjangOperator" id="panjangOperator" style="width: 60px; border: none;"
                                    value="{{ $p_o_e_ms->panjangOperator }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Lebar Operator : <span id="lebarOperatorPrint" style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="lebarOperator" id="lebarOperator"
                                    value="{{ $p_o_e_ms->lebarOperator }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Tinggi : <span id="tinggiPrint"
                                    style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="tinggi" id="tinggi"
                                    value="{{ $p_o_e_ms->tinggi }}" onFocus="startCalc();" onBlur="stopCalc();"
                        ...
                        <tr>
                            ...
                            <td class="text-end">@currency($ms->panel_standard_ms)</td>
                        ...
                        <tr>
                            <td colspan="3"><big><b>Spesifikasi : </b><br><br>1. Mdf Hijau (HMR) <br>2.
                                Rockwool Density 80kg/m3 <br>3. Pe Foam & Yellow Foam<br>4. Finishing Fabric Layer</big></td>
                            <td colspan="3"></td>
                        </tr>
                        <tr>
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_o_e_ms->pintu }}"
                        ...
                        <tr id="jendelaActive">
                            <th colspan="3" style="font-size: 14px; width: 30px;">Jendela Peredam (m2) &nbsp;&nbsp;
                                (<span id="panjangJendelaPrint" style="display: none;"></span><input type="number"
                                    ...
                                    onBlur="stopCalc();" style="width: 65px; height: 23px;"> cm &nbsp;&nbsp; <big><b>x</b></big>
                                &nbsp;&nbsp; <span id="lebarJendelaPrint" style="display: none;"></span><input
                                    type="number" value="0" id="lebarJendela" name="lebarJendela" onFocus="startCalc();"
                                    onBlur="stopCalc();"
                                    style="width: 65px; height: 23px;"> cm)</th>
                        ...
                        <tr style="display: none;" id="jendelaDuaActive">
                            <th colspan="3" style="font-size: 14px; width: 30px;"><button type="button"
                                ...
                                Peredam (m2) &nbsp;&nbsp; (<span id="panjangJendelaDuaPrint"
                                    ...
                                    onBlur="stopCalc();"
                                    style="width: 65px; height: 23px;"> cm &nbsp;&nbsp; <big><b>x</b></big>
                                &nbsp;&nbsp; <span id="lebarJendelaDuaPrint" style="display: none;"></span><input
                                    type="number" value="0" id="lebarJendelaDua" name="lebarJendelaDua" onFocus="startCalc();"
                                    onBlur="stopCalc();"
                                    style="width: 65px; height: 23px;"> cm) </th>
                        ...
                        <tr style="display:none;" id="jendelaTigaActive">
                            <th colspan="3" style="font-size: 14px; width: 30px;"><button type="button"
                                ...
                                &nbsp;&nbsp; <span id="lebarJendelaTigaPrint" style="display: none;"></span><input
                                    type="number" value="0" id="lebarJendelaTiga" name="lebarJendelaTiga" onFocus="startCalc();"
                                    onBlur="stopCalc();"
                                    style="width: 65px; height: 23px;"> cm) </th>
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $panjang;
                            if ($p_o_e_ms->panjangStudio < 3) {
                                $panjang = 1;
                            } elseif ($p_o_e_ms->panjangStudio > 2.9 and $p_o_e_ms->panjangStudio < 5.1) {
                                $panjang = 2;
                            } elseif ($p_o_e_ms->panjangStudio > 5 and $p_o_e_ms->panjangStudio < 7.1) {
                                $panjang = 3;
                            } elseif ($p_o_e_ms->panjangStudio > 7 and $p_o_e_ms->panjangStudio < 9.1) {
                                $panjang = 4;
                            } elseif ($p_o_e_ms->panjangStudio > 9 and $p_o_e_ms->panjangStudio < 11.1) {
                                $panjang = 5;
                            } elseif ($p_o_e_ms->panjangStudio > 11 and $p_o_e_ms->panjangStudio < 13.1) {
                                $panjang = 6;
                            } elseif ($p_o_e_ms->panjangStudio > 13 and $p_o_e_ms->panjangStudio < 15.1) {
                                $panjang = 7;
                            } elseif ($p_o_e_ms->panjangStudio > 15 and $p_o_e_ms->panjangStudio < 17.1) {
                                $panjang = 8;
                            } elseif ($p_o_e_ms->panjangStudio > 17 and $p_o_e_ms->panjangStudio < 19.1) {
                                $panjang = 9;
                            } elseif ($p_o_e_ms->panjangStudio > 19 and $p_o_e_ms->panjangStudio < 21.1) {
                                $panjang = 10;
                            } else {
                                $panjang = 11;
                            }
                            ...
                            $lebar;
                            if (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 3) {
                                $lebar = 1;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 2.9 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 5.1) {
                                $lebar = 2;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 5 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 7.1) {
                                $lebar = 3;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 7 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 9.1) {
                                $lebar = 4;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 9 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 11.1) {
                                $lebar = 5;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 11 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 13.1) {
                                $lebar = 6;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 13 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 15.1) {
                                $lebar = 7;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 15 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 17.1) {
                                $lebar = 8;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 17 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 19.1) {
                                $lebar = 9;
                            } elseif (($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) > 19 and ($p_o_e_ms->lebarStudio) + ($p_o_e_ms->lebarOperator) < 21.1) {
                                $lebar = 10;
                            } else {
                                $lebar = 11;
                            }
                            $jmlLampu = $panjang * $lebar;
                            $jmlStopKontak = round(($panjang * $lebar) / 2);
                        ...
                        <tr id="stopKontakActive">
                            <th colspan="3"><small>B. Instalasi + Material StopKontak <br> <b><span style="color: red;">(Tidak Termasuk Kabel Tufur)</span></b></small></th>
...
<script>
    ...
    function calc() {
        ...
        panjangStudio = document.perhitungan.panjangStudio.value;
        lebarStudio = document.perhitungan.lebarStudio.value;
        panjangOperator = document.perhitungan.panjangOperator.value;
        lebarOperator = document.perhitungan.lebarOperator.value;
        ...
        //Peredam Dinding
        document.getElementById('luasDinding').innerText = parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2);
        document.getElementById('jumlahPeredamDinding').innerText = (parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2)) * {{ $ms->panel_standard_ms }};
        document.getElementById('jumlahPeredamDindingTampil').innerText = Intl.NumberFormat().format((parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2)) * {{ $ms->panel_standard_ms }});

        //Peredam Plafon
        document.getElementById('luasPlafon').innerText = parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(
            2);
        document.getElementById('jumlahPeredamPlafon').innerText = (parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))
            .toFixed(2)) * {{ $ms->panel_standard_ms }};
        document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat(
            (parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(
            2)) * {{ $ms->panel_standard_ms }});
        ...
        //Pemasangan dinding
        document.getElementById('luasDindingPemasangan').innerText = parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2);
        document.getElementById('jumlahPemasanganDinding').innerText = (parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_dinding }};
        document.getElementById('jumlahPemasanganDindingTampil').innerText = Intl.NumberFormat().format((parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_dinding }});

        //Pemasangan Plafon
        document.getElementById('luasPlafonPemasangan').innerText = parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))
            .toFixed(2);
        document.getElementById('jumlahPemasanganPlafon').innerText = (parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))
            .toFixed(2)) * {{ $jasaPeredam->jasa_peredam_plafon }};
        document.getElementById('jumlahPemasanganPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(
        ...
        document.getElementById('pemasanganJendela').innerText = parseFloat(parseFloat((parseInt(panjangJendela) * parseInt(
            ...
            lebarJendelaTiga)) / 10000)).toFixed(1);
        document.getElementById('jumlahPemasanganJendela').innerText = parseFloat(parseFloat((parseInt(panjangJendela) * parseInt(
            lebarJendela)) / 10000) + parseFloat((parseInt(panjangJendelaDua) * parseInt(
            lebarJendelaDua)) / 10000) + parseFloat((parseInt(panjangJendelaTiga) * parseInt(
            lebarJendelaTiga)) / 10000)).toFixed(1) * {{ $jendela->jasa_pasang_jendela }};
        document.getElementById('jumlahPemasanganJendelaTampil').innerText = Intl.NumberFormat().format(parseFloat(parseFloat((parseInt(panjangJendela) * parseInt(
            lebarJendela)) / 10000) + parseFloat((parseInt(panjangJendelaDua) * parseInt(
            lebarJendelaDua)) / 10000) + parseFloat((parseInt(panjangJendelaTiga) * parseInt(
            lebarJendelaTiga)) / 10000)).toFixed(1) * {{ $jendela->jasa_pasang_jendela }});
    ...
    document.getElementById('jumlahPeredamPlafon').innerText = (parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))
        .toFixed(2)) * {{ $ms->panel_standard_ms }};
    //jumlah tampil
    document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat((parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(
        2)) * {{ $ms->panel_standard_ms }});
    ...
    document.getElementById('jumlahPemasanganDinding').innerText = (parseFloat((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator))) *
        parseFloat(tinggi)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_dinding }};
    document.getElementById('jumlahPemasanganDindingTampil').innerText = Intl.NumberFormat().format((parseFloat((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_dinding }});
    ...
    function Show() {
        ...
        document.getElementById('panjangStudioPrint').innerText = parseFloat(panjangStudio).toFixed(2);
        document.getElementById('panjangStudioPrint').style.display = '';
        document.getElementById('panjangStudio').style.display = 'none';

        document.getElementById('lebarStudioPrint').innerText = parseFloat(lebarStudio).toFixed(2);
        document.getElementById('lebarStudioPrint').style.display = '';
        document.getElementById('lebarStudio').style.display = 'none';

        document.getElementById('panjangOperatorPrint').innerText = parseFloat(panjangOperator).toFixed(2);
        document.getElementById('panjangOperatorPrint').style.display = '';
        document.getElementById('panjangOperator').style.display = 'none';

        document.getElementById('lebarOperatorPrint').innerText = parseFloat(lebarOperator).toFixed(2);
        document.getElementById('lebarOperatorPrint').style.display = '';
        document.getElementById('lebarOperator').style.display = 'none';
