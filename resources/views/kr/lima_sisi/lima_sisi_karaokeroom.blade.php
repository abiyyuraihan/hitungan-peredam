...
<head>
    ...
    <script>
        function PenawaranLimaSisiKrGs() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_gs";
        }

        function PenawaranLimaSisiKrGm() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_gm";
        }

        function PenawaranLimaSisiKrGh() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_gh";
        }

        function PenawaranLimaSisiKrAs() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_as";
        }

        function PenawaranLimaSisiKrAm() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_am";
        }

        function PenawaranLimaSisiKrAh() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_ah";
        }

        function PenawaranLimaSisiKrAd() {
            document.forms['perhitungan'].action = "/kr_penawaran_ls_ad";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranLimaSisiKrAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
