    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/kr_penawaran_ls_as@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td class="text-center">
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * ($_GET['tinggi'] / 100) ?>
                        </td>
                        <td class="text-end">@currency($kr->panel_standard_kr)</td>
                        <td id="jumlahPeredamDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * ($_GET['tinggi'] / 100)) * $kr->panel_standard_kr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * ($_GET['tinggi'] / 100)) * $kr->panel_standard_kr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td class="text-center"><?= ($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) ?></td>
                        <td class="text-end">@currency($kr->panel_standard_kr)</td>
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $kr->panel_standard_kr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $kr->panel_standard_kr, 0, ',', '.') ?>
                        </td>
                    </tr>
                    ...
                    <tr id="activePemasanganDinding"
                        ...
                        <td id="jumlahPemasanganDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100))  * ($_GET['tinggi'] / 100)) * $jasaPeredam->jasa_peredam_dinding ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100))  * ($_GET['tinggi'] / 100)) * $jasaPeredam->jasa_peredam_dinding, 0, ',', '.') ?>
                        </td>
                    </tr>
                    <tr id="activePemasanganPlafon"
                        ...
                        <td class="text-center">
                            <?= ($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)  ?></td>
                        <td class="text-end">@currency($jasaPeredam->jasa_peredam_plafon)</td>
                        <td id="jumlahPemasanganPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $jasaPeredam->jasa_peredam_plafon ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $jasaPeredam->jasa_peredam_plafon, 0, ',', '.') ?>
                        </td>
                    </tr>
                    ...
                    <tr id="listrikActive" style="display: none; background-color: rgb(255, 246, 215);">
                        ...
                        <td hidden><?php
                        $dindingTiga;
                        if ($_GET['dindingTiga'] / 100 < 3) {
                            $dindingTiga = 1;
                        } elseif ($_GET['dindingTiga'] / 100 > 2.9 and $_GET['dindingTiga'] / 100 < 5.1) {
                            $dindingTiga = 2;
                        } elseif ($_GET['dindingTiga'] / 100 > 5 and $_GET['dindingTiga'] / 100 < 7.1) {
                            $dindingTiga = 3;
                        } elseif ($_GET['dindingTiga'] / 100 > 7 and $_GET['dindingTiga'] / 100 < 9.1) {
                            $dindingTiga = 4;
                        } elseif ($_GET['dindingTiga'] / 100 > 9 and $_GET['dindingTiga'] / 100 < 11.1) {
                            $dindingTiga = 5;
                        } elseif ($_GET['dindingTiga'] / 100 > 11 and $_GET['dindingTiga'] / 100 < 13.1) {
                            $dindingTiga = 6;
                        } elseif ($_GET['dindingTiga'] / 100 > 13 and $_GET['dindingTiga'] / 100 < 15.1) {
                            $dindingTiga = 7;
                        } elseif ($_GET['dindingTiga'] / 100 > 15 and $_GET['dindingTiga'] / 100 < 17.1) {
                            $dindingTiga = 8;
                        } elseif ($_GET['dindingTiga'] / 100 > 17 and $_GET['dindingTiga'] / 100 < 19.1) {
                            $dindingTiga = 9;
                        } elseif ($_GET['dindingTiga'] / 100 > 19 and $_GET['dindingTiga'] / 100 < 21.1) {
                            $dindingTiga = 10;
                        } else {
                            $dindingTiga = 11;
                        }
