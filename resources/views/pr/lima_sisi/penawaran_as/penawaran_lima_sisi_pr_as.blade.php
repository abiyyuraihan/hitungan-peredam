    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/pr_penawaran_ls_as@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td id="jumlahPeredamDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * ($_GET['tinggi'] / 100)) * $pr->panel_standard_pr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * ($_GET['tinggi'] / 100)) * $pr->panel_standard_pr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $pr->panel_standard_pr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100)) * $pr->panel_standard_pr, 0, ',', '.') ?>
                        </td>
                    </tr>
