    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/mr_penawaran_ens_gm@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td class="text-end">@currency($mr->gypsum_medium_mr)</td>
                        <td id="jumlahPeredamDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $mr->gypsum_medium_mr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $mr->gypsum_medium_mr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $mr->gypsum_medium_mr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $mr->gypsum_medium_mr, 0, ',', '.') ?>
                        </td>
                    </tr>
