                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <td colspan="3"><big><b>Spesifikasi : </b><br><br>1. Rangka Metal Stud U Runner <br>2.
                                    Rockwool Density 40kg/m3 <br>3. Finishing Cat</big></td>
                            <td colspan="3"></td>
                        </tr>
                        <tr>
...
<script>
    ...
    function calc() {
        ...
        document.getElementById('jumlahPeredamDinding').innerText = (parseFloat(2 * (parseFloat(
                panjang) + parseFloat(
                lebar)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $pr->gypsum_standard_pr }};
        ...
        document.getElementById('jumlahPeredamPlafon').innerText = (parseFloat(parseFloat(panjang) * parseFloat(lebar))
            .toFixed(2)) * {{ $pr->gypsum_standard_pr }};
