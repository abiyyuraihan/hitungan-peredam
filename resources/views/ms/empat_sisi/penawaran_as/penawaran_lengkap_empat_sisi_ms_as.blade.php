...
<head>
    ...
    <title>Penawaran {{ $p_es_ms->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_es_ms->nama }} <br>Lokasi :
                                        {{ $p_es_ms->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_es_ms->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_es_ms->foto1) }}"
                                                alt="{{ $p_es_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_es_ms->foto2) }}"
                                                alt="{{ $p_es_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_es_ms->foto3) }}"
                                                alt="{{ $p_es_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr class="text-end">
                            <th colspan="6">Panjang : <span id="panjangPrint" style="display: none;"></span><input
                                    type="number" name="panjang" id="panjang" style="width: 60px; border: none;"
                                    value="{{ $p_es_ms->panjang }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;&nbsp;
                                Lebar : <span id="lebarPrint" style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="lebar" id="lebar"
                                    value="{{ $p_es_ms->lebar }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;&nbsp; Tinggi : <span id="tinggiPrint"
                                    style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="tinggi" id="tinggi"
                                    value="{{ $p_es_ms->tinggi }}" onFocus="startCalc();" onBlur="stopCalc();"
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_es_ms->pintu }}"
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $panjang;
                            if ($p_es_ms->panjang < 3) {
                                $panjang = 1;
                            } elseif ($p_es_ms->panjang > 2.9 and $p_es_ms->panjang < 5.1) {
                                $panjang = 2;
                            } elseif ($p_es_ms->panjang > 5 and $p_es_ms->panjang < 7.1) {
                                $panjang = 3;
                            } elseif ($p_es_ms->panjang > 7 and $p_es_ms->panjang < 9.1) {
                                $panjang = 4;
                            } elseif ($p_es_ms->panjang > 9 and $p_es_ms->panjang < 11.1) {
                                $panjang = 5;
                            } elseif ($p_es_ms->panjang > 11 and $p_es_ms->panjang < 13.1) {
                                $panjang = 6;
                            } elseif ($p_es_ms->panjang > 13 and $p_es_ms->panjang < 15.1) {
                                $panjang = 7;
                            } elseif ($p_es_ms->panjang > 15 and $p_es_ms->panjang < 17.1) {
                                $panjang = 8;
                            } elseif ($p_es_ms->panjang > 17 and $p_es_ms->panjang < 19.1) {
                                $panjang = 9;
                            } elseif ($p_es_ms->panjang > 19 and $p_es_ms->panjang < 21.1) {
                                $panjang = 10;
                            } else {
                                $panjang = 11;
                            }
                            ...
                            if ($p_es_ms->lebar < 3) {
                                $lebar = 1;
                            } elseif ($p_es_ms->lebar > 2.9 and $p_es_ms->lebar < 5.1) {
                                $lebar = 2;
                            } elseif ($p_es_ms->lebar > 5 and $p_es_ms->lebar < 7.1) {
                                $lebar = 3;
                            } elseif ($p_es_ms->lebar > 7 and $p_es_ms->lebar < 9.1) {
                                $lebar = 4;
                            } elseif ($p_es_ms->lebar > 9 and $p_es_ms->lebar < 11.1) {
                                $lebar = 5;
                            } elseif ($p_es_ms->lebar > 11 and $p_es_ms->lebar < 13.1) {
                                $lebar = 6;
                            } elseif ($p_es_ms->lebar > 13 and $p_es_ms->lebar < 15.1) {
                                $lebar = 7;
                            } elseif ($p_es_ms->lebar > 15 and $p_es_ms->lebar < 17.1) {
                                $lebar = 8;
                            } elseif ($p_es_ms->lebar > 17 and $p_es_ms->lebar < 19.1) {
                                $lebar = 9;
                            } elseif ($p_es_ms->lebar > 19 and $p_es_ms->lebar < 21.1) {
                                $lebar = 10;
                            } else {
                                $lebar = 11;
                            }
...
<script>
    ...
    function calc() {
        ...
        panjang = document.perhitungan.panjang.value;
        lebar = document.perhitungan.lebar.value;
        ...
        //Peredam Dinding
        document.getElementById('luasDinding').innerText = parseFloat(2 * (parseFloat(panjang) + parseFloat(lebar)) *
            parseFloat(tinggi)).toFixed(2);
        document.getElementById('jumlahPeredamDinding').innerText = (parseFloat(2 * (parseFloat(
                panjang) + parseFloat(
                lebar)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $ms->panel_standard_ms }};
        document.getElementById('jumlahPeredamDindingTampil').innerText = Intl.NumberFormat().format((parseFloat(2 * (
                parseFloat(
                    panjang) + parseFloat(
                    lebar)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $ms->panel_standard_ms }});
        ...
        //Peredam Plafon
        document.getElementById('luasPlafon').innerText = parseFloat(parseFloat(panjang) * parseFloat(lebar)).toFixed(
            2);
        document.getElementById('jumlahPeredamPlafon').innerText = (parseFloat(parseFloat(panjang) * parseFloat(lebar))
        ...
        document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat(
            parseFloat(panjang) * parseFloat(lebar)).toFixed(
        ...
        //Pemasangan dinding
        document.getElementById('luasDindingPemasangan').innerText = parseFloat(2 * (parseFloat(panjang) + parseFloat(
                lebar)) *
            parseFloat(tinggi)).toFixed(2);
        document.getElementById('jumlahPemasanganDinding').innerText = (parseFloat(2 * (parseFloat(
                panjang) + parseFloat(
                lebar)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_dinding }};
        document.getElementById('jumlahPemasanganDindingTampil').innerText = Intl.NumberFormat().format((parseFloat(2 *
            (
                parseFloat(
                    panjang) + parseFloat(
                    lebar)) *
        ...
        //Pemasangan Plafon
        document.getElementById('luasPlafonPemasangan').innerText = parseFloat(parseFloat(panjang) * parseFloat(lebar))
            .toFixed(2);
        document.getElementById('jumlahPemasanganPlafon').innerText = (parseFloat(parseFloat(panjang) * parseFloat(
                lebar))
    ...
    document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat(parseFloat(
        panjang) * parseFloat(lebar)).toFixed(
        2)) * {{ $ms->panel_standard_ms }});
    ...
    function Show() {
        ...
        document.getElementById('panjangPrint').innerText = parseFloat(panjang).toFixed(2);
        document.getElementById('panjangPrint').style.display = '';
        document.getElementById('panjang').style.display = 'none';

        document.getElementById('lebarPrint').innerText = parseFloat(lebar).toFixed(2);
        document.getElementById('lebarPrint').style.display = '';
