    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/gr_penawaran_ens_as@store"
                    enctype="multipart/form-data">
                    @csrf
                    <input type="text" id="mrType" name="mrType" value="as" hidden>
                    ...
                    <tr style="background-color: rgb(233, 231, 231);">
                        <?php
                        $dindingSatu = $_GET['dindingSatu'] / 100;
                        $dindingDua = $_GET['dindingDua'] / 100;
                        $dindingTiga = $_GET['dindingTiga'] / 100;
                        $dindingEmpat = $_GET['dindingEmpat'] / 100;
                        $dindingLima = $_GET['dindingLima'] / 100;
                        $dindingEnam = $_GET['dindingEnam'] / 100;
                        $tinggi = $_GET['tinggi'] / 100;
                        ?>
                        <th hidden>Dinding Satu :<input type="text" value="<?= $dindingSatu ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingSatu"
                                readonly hidden></th>
                        <th hidden>Dinding Dua :<input type="text" value="<?= $dindingDua ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingDua"
                                readonly hidden></th>
                        <th hidden>Dinding Tiga :<input type="text" value="<?= $dindingTiga ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingTiga"
                                readonly hidden></th>
                        <th hidden>Dinding Empat :<input type="text" value="<?= $dindingEmpat ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingEmpat"
                                readonly hidden></th>
                        <th hidden>Dinding Lima :<input type="text" value="<?= $dindingLima ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingLima"
                                readonly hidden></th>
                        <th hidden>Dinding Enam :<input type="text" value="<?= $dindingEnam ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="dindingEnam"
                                readonly hidden></th>
                        <th hidden>Tinggi :<input type="text" value="<?= $tinggi ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="tinggi"
                                readonly hidden></th>
                        <th colspan="6">DindingSatu : <?= $dindingSatu ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp;
                            DindingDua : <?= $dindingDua ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp;
                            DindingTiga : <?= $dindingTiga ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp;
                            DindingEmpat : <?= $dindingEmpat ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp;
                            DindingLima : <?= $dindingLima ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp;
                            DindingEnam : <?= $dindingEnam ?>
                            &nbsp;&nbsp;||&nbsp;&nbsp; Tinggi : <?= $tinggi ?></th>
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td class="text-center">
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100) ?>
                        </td>
                        <td class="text-end">@currency($gr->panel_standard_gr)</td>
                        <td id="jumlahPeredamDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $gr->panel_standard_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $gr->panel_standard_gr, 0, ',', '.') ?>
                        </td>

                    </tr>

                    <tr>
                        <td colspan="6" style="background-color: rgb(255, 246, 215);">spek : <small>MDF Hijau (HMR), Rockwool
                            Density 60 kg/m3, Pe Foam & Yellow Foam, Finishing Fabric Layer</small></td>
                    </tr>


                    <tr style="background-color: rgb(252, 234, 168);">
                        <th colspan="3">Peredam Plafon (m2)</th>
                        <td class="text-center"><?= ($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100) ?></td>
                        <td class="text-end">@currency($gr->panel_standard_gr)</td>
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $gr->panel_standard_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $gr->panel_standard_gr, 0, ',', '.') ?>
                        </td>
                    </tr>

                    <tr style="background-color: rgb(252, 234, 168);">
                        <td colspan="6">spek : <small>MDF Hijau (HMR), Rockwool
                            Density 60 kg/m3, Pe Foam & Yellow Foam, Finishing Fabric Layer</small></td>
                    </tr>
                    ...
                    <tr id="activePemasanganDinding"
                        ...
                        <td id="jumlahPemasanganDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100))  * ($_GET['tinggi'] / 100)) * $jasaPeredam->jasa_peredam_dinding ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100))  * ($_GET['tinggi'] / 100)) * $jasaPeredam->jasa_peredam_dinding, 0, ',', '.') ?>
                        </td>
                    </tr>
                    <tr id="activePemasanganPlafon"
                        ...
                        <td class="text-center">
                            <?= ($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)  ?></td>
                        <td class="text-end">@currency($jasaPeredam->jasa_peredam_plafon)</td>
                        <td id="jumlahPemasanganPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $jasaPeredam->jasa_peredam_plafon ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $jasaPeredam->jasa_peredam_plafon, 0, ',', '.') ?>
                        </td>
                    </tr>
                    ...
                    <tr id="listrikActive" style="display: none; background-color: rgb(255, 246, 215);">
                        ...
                        <td hidden><?php
                        $dindingSatu;
                        if ($_GET['dindingSatu'] / 100 < 3) {
                            $dindingSatu = 1;
                        } elseif ($_GET['dindingSatu'] / 100 > 2.9 and $_GET['dindingSatu'] / 100 < 5.1) {
                            $dindingSatu = 2;
                        } elseif ($_GET['dindingSatu'] / 100 > 5 and $_GET['dindingSatu'] / 100 < 7.1) {
                            $dindingSatu = 3;
                        } elseif ($_GET['dindingSatu'] / 100 > 7 and $_GET['dindingSatu'] / 100 < 9.1) {
                            $dindingSatu = 4;
                        } elseif ($_GET['dindingSatu'] / 100 > 9 and $_GET['dindingSatu'] / 100 < 11.1) {
                            $dindingSatu = 5;
                        } elseif ($_GET['dindingSatu'] / 100 > 11 and $_GET['dindingSatu'] / 100 < 13.1) {
                            $dindingSatu = 6;
                        } elseif ($_GET['dindingSatu'] / 100 > 13 and $_GET['dindingSatu'] / 100 < 15.1) {
                            $dindingSatu = 7;
                        } elseif ($_GET['dindingSatu'] / 100 > 15 and $_GET['dindingSatu'] / 100 < 17.1) {
                            $dindingSatu = 8;
                        } elseif ($_GET['dindingSatu'] / 100 > 17 and $_GET['dindingSatu'] / 100 < 19.1) {
                            $dindingSatu = 9;
                        } elseif ($_GET['dindingSatu'] / 100 > 19 and $_GET['dindingSatu'] / 100 < 21.1) {
                            $dindingSatu = 10;
                        } else {
                            $dindingSatu = 11;
                        }
                        ...
                        $dindingDua;
                        if ($_GET['dindingDua'] / 100 < 3) {
                            $dindingDua = 1;
                        } elseif ($_GET['dindingDua'] / 100 > 2.9 and $_GET['dindingDua'] / 100 < 5.1) {
                            $dindingDua = 2;
                        } elseif ($_GET['dindingDua'] / 100 > 5 and $_GET['dindingDua'] / 100 < 7.1) {
                            $dindingDua = 3;
                        } elseif ($_GET['dindingDua'] / 100 > 7 and $_GET['dindingDua'] / 100 < 9.1) {
                            $dindingDua = 4;
                        } elseif ($_GET['dindingDua'] / 100 > 9 and $_GET['dindingDua'] / 100 < 11.1) {
                            $dindingDua = 5;
                        } elseif ($_GET['dindingDua'] / 100 > 11 and $_GET['dindingDua'] / 100 < 13.1) {
                            $dindingDua = 6;
                        } elseif ($_GET['dindingDua'] / 100 > 13 and $_GET['dindingDua'] / 100 < 15.1) {
                            $dindingDua = 7;
                        } elseif ($_GET['dindingDua'] / 100 > 15 and $_GET['dindingDua'] / 100 < 17.1) {
                            $dindingDua = 8;
                        } elseif ($_GET['dindingDua'] / 100 > 17 and $_GET['dindingDua'] / 100 < 19.1) {
                            $dindingDua = 9;
                        } elseif ($_GET['dindingDua'] / 100 > 19 and $_GET['dindingDua'] / 100 < 21.1) {
                            $dindingDua = 10;
                        } else {
                            $dindingDua = 11;
                        }
                        $jmlLampu = $dindingSatu * $dindingDua;
                        $jmlStopKontak = round(($dindingSatu * $dindingDua) / 2);
