...
<head>
    ...
    <title>Penawaran {{ $p_ls_mr->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_ls_mr->nama }} <br>Lokasi :
                                        {{ $p_ls_mr->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_ls_mr->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_ls_mr->foto1) }}"
                                                alt="{{ $p_ls_mr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_ls_mr->foto2) }}"
                                                alt="{{ $p_ls_mr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_ls_mr->foto3) }}"
                                                alt="{{ $p_ls_mr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr class="text-end">
                            <th colspan="6">
                                Dinding Satu : <span id="dindingSatuPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ls_mr->dindingSatu }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Dua : <span id="dindingDuaPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ls_mr->dindingDua }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Tiga : <span id="dindingTigaPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ls_mr->dindingTiga }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Empat : <span id="dindingEmpatPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ls_mr->dindingEmpat }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_ls_mr->pintu }}"
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $dindingTiga;
                            if ($p_ls_mr->dindingTiga < 3) {
                                $dindingTiga = 1;
                            } elseif ($p_ls_mr->dindingTiga > 2.9 and $p_ls_mr->dindingTiga < 5.1) {
                                $dindingTiga = 2;
                            } elseif ($p_ls_mr->dindingTiga > 5 and $p_ls_mr->dindingTiga < 7.1) {
                                $dindingTiga = 3;
                            } elseif ($p_ls_mr->dindingTiga > 7 and $p_ls_mr->dindingTiga < 9.1) {
                                $dindingTiga = 4;
                            } elseif ($p_ls_mr->dindingTiga > 9 and $p_ls_mr->dindingTiga < 11.1) {
                                $dindingTiga = 5;
                            } elseif ($p_ls_mr->dindingTiga > 11 and $p_ls_mr->dindingTiga < 13.1) {
                                $dindingTiga = 6;
                            } elseif ($p_ls_mr->dindingTiga > 13 and $p_ls_mr->dindingTiga < 15.1) {
                                $dindingTiga = 7;
                            } elseif ($p_ls_mr->dindingTiga > 15 and $p_ls_mr->dindingTiga < 17.1) {
                                $dindingTiga = 8;
                            } elseif ($p_ls_mr->dindingTiga > 17 and $p_ls_mr->dindingTiga < 19.1) {
                                $dindingTiga = 9;
                            } elseif ($p_ls_mr->dindingTiga > 19 and $p_ls_mr->dindingTiga < 21.1) {
                                $dindingTiga = 10;
                            } else {
                                $dindingTiga = 11;
                            }
                            ...
                            $dindingDua;
                            if ($p_ls_mr->dindingDua < 3) {
                                $dindingDua = 1;
                            } elseif ($p_ls_mr->dindingDua > 2.9 and $p_ls_mr->dindingDua < 5.1) {
                                $dindingDua = 2;
                            } elseif ($p_ls_mr->dindingDua > 5 and $p_ls_mr->dindingDua < 7.1) {
                                $dindingDua = 3;
                            } elseif ($p_ls_mr->dindingDua > 7 and $p_ls_mr->dindingDua < 9.1) {
                                $dindingDua = 4;
                            } elseif ($p_ls_mr->dindingDua > 9 and $p_ls_mr->dindingDua < 11.1) {
                                $dindingDua = 5;
                            } elseif ($p_ls_mr->dindingDua > 11 and $p_ls_mr->dindingDua < 13.1) {
                                $dindingDua = 6;
                            } elseif ($p_ls_mr->dindingDua > 13 and $p_ls_mr->dindingDua < 15.1) {
                                $dindingDua = 7;
                            } elseif ($p_ls_mr->dindingDua > 15 and $p_ls_mr->dindingDua < 17.1) {
                                $dindingDua = 8;
                            } elseif ($p_ls_mr->dindingDua > 17 and $p_ls_mr->dindingDua < 19.1) {
                                $dindingDua = 9;
                            } elseif ($p_ls_mr->dindingDua > 19 and $p_ls_mr->dindingDua < 21.1) {
                                $dindingDua = 10;
                            } else {
                                $dindingDua = 11;
                            }
