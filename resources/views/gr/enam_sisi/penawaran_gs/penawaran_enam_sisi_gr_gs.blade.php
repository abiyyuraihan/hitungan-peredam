    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/gr_penawaran_ens_gs@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td id="jumlahPeredamDinding" hidden>
                            <?= ((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $gr->gypsum_standard_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * ($_GET['tinggi'] / 100)) * $gr->gypsum_standard_gr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr>
                        <td colspan="6" style="background-color: rgb(255, 246, 215);">spek : <small>Rangka
                                ...
                                U
                                Runner, Rockwool
                                Density 60 kg/m3, Finishing Cat</small></td>
                    </tr>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= (($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $gr->gypsum_standard_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format((($_GET['dindingSatu'] / 100) + ($_GET['dindingDua'] / 100) + ($_GET['dindingTiga'] / 100) + ($_GET['dindingEmpat'] / 100) + ($_GET['dindingLima'] / 100) + ($_GET['dindingEnam'] / 100)) * $gr->gypsum_standard_gr, 0, ',', '.') ?>
                        </td>
                    </tr>
