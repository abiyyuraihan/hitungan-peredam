...
<head>
    ...
    <script>
        function PenawaranLimaSisiGrGs() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_gs";
        }

        function PenawaranLimaSisiGrGm() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_gm";
        }

        function PenawaranLimaSisiGrGh() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_gh";
        }

        function PenawaranLimaSisiGrAs() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_as";
        }

        function PenawaranLimaSisiGrAm() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_am";
        }

        function PenawaranLimaSisiGrAh() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_ah";
        }

        function PenawaranLimaSisiGrAd() {
            document.forms['perhitungan'].action = "/gr_penawaran_ls_ad";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranLimaSisiGrAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
    ...
    <script>
        ...
        function calc() {
            ...
            document.getElementById('totalGSbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                ...
                {{ $gr->gypsum_standard_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalGMbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $gr->gypsum_medium_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalGHbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $gr->gypsum_high_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                2) * {{ $gr->gypsum_high_gr }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            ...
            document.getElementById('totalASbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $gr->panel_standard_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalASbarangDANpemasangan').innerText = formatRupiah(((parseFloat(parseFloat(
                ...
                document.getElementById('totalAMbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $gr->panel_medium_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                ...
                document.getElementById('totalAHbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $gr->panel_high_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                    2) * {{ $gr->panel_high_gr }}) + (
                    parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
                ...
                document.getElementById('totalADbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $gr->panel_deluxe_gr }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
