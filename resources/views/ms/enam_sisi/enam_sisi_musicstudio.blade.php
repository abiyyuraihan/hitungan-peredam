...
<head>
    ...
    <script>
        function PenawaranEnamSisiMsGs() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_gs";
        }

        function PenawaranEnamSisiMsGm() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_gm";
        }

        function PenawaranEnamSisiMsGh() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_gh";
        }

        function PenawaranEnamSisiMsAs() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_as";
        }

        function PenawaranEnamSisiMsAm() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_am";
        }

        function PenawaranEnamSisiMsAh() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_ah";
        }

        function PenawaranEnamSisiMsAd() {
            document.forms['perhitungan'].action = "/ms_penawaran_ens_ad";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranEnamSisiMsAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
