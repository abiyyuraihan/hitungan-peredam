...
<head>
    ...
    <title>Penawaran {{ $p_ens_gr->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_ens_gr->nama }} <br>Lokasi :
                                        {{ $p_ens_gr->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_ens_gr->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_ens_gr->foto1) }}"
                                                alt="{{ $p_ens_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_ens_gr->foto2) }}"
                                                alt="{{ $p_ens_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_ens_gr->foto3) }}"
                                                alt="{{ $p_ens_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr class="text-end">
                            <th colspan="6">
                                Dinding Satu : <span id="dindingSatuPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ens_gr->dindingSatu }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Dua : <span id="dindingDuaPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ens_gr->dindingDua }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Tiga : <span id="dindingTigaPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ens_gr->dindingTiga }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Empat : <span id="dindingEmpatPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ens_gr->dindingEmpat }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Lima : <span id="dindingLimaPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_ens_gr->dindingLima }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Dinding Enam : <span id="dindingEnamPrint" style="display: none;"></span><input
                                    type="number" name="dindingEnam" id="dindingEnam" style="width: 60px; border: none;"
                                    value="{{ $p_ens_gr->dindingEnam }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp; 
                                Tinggi : <span id="tinggiPrint"
                                    style="display: none;"></span><input type="number"
                                    style="width: 60px; border: none;" name="tinggi" id="tinggi"
                                    value="{{ $p_ens_gr->tinggi }}" onFocus="startCalc();" onBlur="stopCalc();"
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_ens_gr->pintu }}"
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $dindingSatu;
                            if ($p_ens_gr->dindingSatu < 3) {
                                $dindingSatu = 1;
                            } elseif ($p_ens_gr->dindingSatu > 2.9 and $p_ens_gr->dindingSatu < 5.1) {
                                $dindingSatu = 2;
                            } elseif ($p_ens_gr->dindingSatu > 5 and $p_ens_gr->dindingSatu < 7.1) {
                                $dindingSatu = 3;
                            } elseif ($p_ens_gr->dindingSatu > 7 and $p_ens_gr->dindingSatu < 9.1) {
                                $dindingSatu = 4;
                            } elseif ($p_ens_gr->dindingSatu > 9 and $p_ens_gr->dindingSatu < 11.1) {
                                $dindingSatu = 5;
                            } elseif ($p_ens_gr->dindingSatu > 11 and $p_ens_gr->dindingSatu < 13.1) {
                                $dindingSatu = 6;
                            } elseif ($p_ens_gr->dindingSatu > 13 and $p_ens_gr->dindingSatu < 15.1) {
                                $dindingSatu = 7;
                            } elseif ($p_ens_gr->dindingSatu > 15 and $p_ens_gr->dindingSatu < 17.1) {
                                $dindingSatu = 8;
                            } elseif ($p_ens_gr->dindingSatu > 17 and $p_ens_gr->dindingSatu < 19.1) {
                                $dindingSatu = 9;
                            } elseif ($p_ens_gr->dindingSatu > 19 and $p_ens_gr->dindingSatu < 21.1) {
                                $dindingSatu = 10;
                            } else {
                                $dindingSatu = 11;
                            }
                            ...
                            $dindingDua;
                            if ($p_ens_gr->dindingDua < 3) {
                                $dindingDua = 1;
                            } elseif ($p_ens_gr->dindingDua > 2.9 and $p_ens_gr->dindingDua < 5.1) {
                                $dindingDua = 2;
                            } elseif ($p_ens_gr->dindingDua > 5 and $p_ens_gr->dindingDua < 7.1) {
                                $dindingDua = 3;
                            } elseif ($p_ens_gr->dindingDua > 7 and $p_ens_gr->dindingDua < 9.1) {
                                $dindingDua = 4;
                            } elseif ($p_ens_gr->dindingDua > 9 and $p_ens_gr->dindingDua < 11.1) {
                                $dindingDua = 5;
                            } elseif ($p_ens_gr->dindingDua > 11 and $p_ens_gr->dindingDua < 13.1) {
                                $dindingDua = 6;
                            } elseif ($p_ens_gr->dindingDua > 13 and $p_ens_gr->dindingDua < 15.1) {
                                $dindingDua = 7;
                            } elseif ($p_ens_gr->dindingDua > 15 and $p_ens_gr->dindingDua < 17.1) {
                                $dindingDua = 8;
                            } elseif ($p_ens_gr->dindingDua > 17 and $p_ens_gr->dindingDua < 19.1) {
                                $dindingDua = 9;
                            } elseif ($p_ens_gr->dindingDua > 19 and $p_ens_gr->dindingDua < 21.1) {
                                $dindingDua = 10;
                            } else {
                                $dindingDua = 11;
                            }
...
<script>
    ...
    function calc() {
        ...
        dindingEnam = document.perhitungan.dindingEnam.value;
        ...
        document.getElementById('luasDinding').innerText = parseFloat((parseFloat(dindingSatu) + parseFloat(
                dindingDua) + parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima) + parseFloat(dindingEnam)) *
        ...
        document.getElementById('jumlahPeredamDindingTampil').innerText = Intl.NumberFormat().format((parseFloat((
                parseFloat(dindingSatu) + parseFloat(dindingDua) + parseFloat(dindingTiga) + parseFloat(
                    dindingEmpat) + parseFloat(dindingLima) + parseFloat(dindingEnam)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $gr->panel_standard_gr }});
        ...
        document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat(
            parseFloat(dindingSatu) + parseFloat(dindingDua) + parseFloat(dindingTiga) + parseFloat(
                dindingEmpat) + parseFloat(dindingLima) + parseFloat(dindingEnam)).toFixed(
        ...
        document.getElementById('jumlahPemasanganDinding').innerText = (parseFloat((parseFloat(dindingSatu) +
                parseFloat(dindingDua) + parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(
                    dindingLima) + parseFloat(dindingEnam)) *
    ...
    document.getElementById('luasDinding').innerText = parseFloat((parseFloat(dindingSatu) + parseFloat(dindingDua) +
            parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima) + parseFloat(dindingEnam)) *
        parseFloat(tinggi)).toFixed(2);
    // jumlah
    document.getElementById('jumlahPeredamDinding').innerText = (parseFloat((parseFloat(dindingSatu) + parseFloat(
            dindingDua) + parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima) + parseFloat(dindingEnam)) *
    ...
    document.getElementById('jumlahPeredamPlafonTampil').innerText = Intl.NumberFormat().format((parseFloat(parseFloat(
        ...
        parseFloat(dindingLima) + parseFloat(dindingEnam)).toFixed(
        2)) * {{ $gr->panel_standard_gr }});
    ...
    function Show() {
        ...
        document.getElementById('dindingEnamPrint').innerText = parseFloat(dindingEnam).toFixed(2);
        document.getElementById('dindingEnamPrint').style.display = '';
        document.getElementById('dindingEnam').style.display = 'none';
