...
<head>
    ...
    <script>
        function PenawaranEnamSisiGrGs() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_gs";
        }

        function PenawaranEnamSisiGrGm() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_gm";
        }

        function PenawaranEnamSisiGrGh() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_gh";
        }

        function PenawaranEnamSisiGrAs() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_as";
        }

        function PenawaranEnamSisiGrAm() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_am";
        }

        function PenawaranEnamSisiGrAh() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_ah";
        }

        function PenawaranEnamSisiGrAd() {
            document.forms['perhitungan'].action = "/gr_penawaran_ens_ad";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranEnamSisiGrAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
