...
<head>
    ...
    <script>
        function PenawaranEmpatSisiMsGs() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_gs";
        }

        function PenawaranEmpatSisiMsGm() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_gm";
        }

        function PenawaranEmpatSisiMsGh() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_gh";
        }

        function PenawaranEmpatSisiMsAs() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_as";
        }

        function PenawaranEmpatSisiMsAm() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_am";
        }

        function PenawaranEmpatSisiMsAh() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_ah";
        }

        function PenawaranEmpatSisiMsAd() {
            document.forms['perhitungan'].action = "/ms_penawaran_es_ad";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardGypsum"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsGs()"
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="mediumGypsum"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsGm()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="highGypsum"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsGh()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="mediumAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsAm()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="highAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsAh()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="deluxeAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranEmpatSisiMsAd()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
    ...
    <script>
        ...
        function calc() {
            ...
            document.getElementById('totalGSbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                parseFloat(lebar))) * {{ $ms->gypsum_standard_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
            ...
            document.getElementById('totalGMbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->gypsum_medium_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Gypsum High
            document.getElementById('totalGHbarang').innerText = formatRupiah((parseFloat(((2 * (parseFloat(panjang) +
                    parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) * parseFloat(lebar))) *
                {{ $ms->gypsum_high_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalGHpemasangan').innerText = formatRupiah(((parseFloat(2 * (parseFloat(panjang) +
                    parseFloat(lebar)) * parseFloat(tinggi)).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
                (parseFloat(parseFloat(panjang) *
                    parseFloat(lebar)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_plafon }}) + (parseInt(
            ...
            document.getElementById('totalGHbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->gypsum_high_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));
            ...
            document.getElementById('totalASbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->panel_standard_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));
            ...
            document.getElementById('totalAMbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->panel_medium_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));
            ...
            document.getElementById('totalAHbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->panel_high_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Panel Akustik Deluxe
            document.getElementById('totalADbarang').innerText = formatRupiah((parseFloat(((2 * (parseFloat(panjang) +
                    parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) * parseFloat(lebar))) *
                {{ $ms->panel_deluxe_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalADpemasangan').innerText = formatRupiah(((parseFloat(2 * (parseFloat(panjang) +
                    parseFloat(lebar)) * parseFloat(tinggi)).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
                (parseFloat(parseFloat(panjang) *
                    parseFloat(lebar)).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_plafon }}) + (parseInt(
            ...
            document.getElementById('totalADbarangDANpemasangan').innerText = formatRupiah((((parseFloat(2 * (parseFloat(
                ...
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat(((2 * (parseFloat(
                panjang) + parseFloat(lebar))) * parseFloat(tinggi)) + (parseFloat(panjang) *
                parseFloat(lebar))) * {{ $ms->panel_deluxe_ms }}) + ((parseInt(jmlPintu) * ((81 * 210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));
