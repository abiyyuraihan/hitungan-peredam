                ...
                <table class="table table-bordered border-dark">
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            ...
                            <td class="text-end">@currency($ms->panel_deluxe_ms)</td>
                        ...
                        <tr>
                            <td colspan="3"><big><b>Spesifikasi : </b><br><br>1. Mdf Hijau (HMR) <br>2.
                                Rockwool Density 140kg/m3 <br>3. Pe Foam & Yellow Foam<br>4. Finishing Fabric Layer</big></td>
                            <td colspan="3"></td>
                        </tr>
                        <tr>
...
<script>
    ...
    function calc() {
        ...
        document.getElementById('jumlahPeredamDinding').innerText = (parseFloat(((2 * (parseFloat(panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)))) *
            parseFloat(tinggi)).toFixed(2)) * {{ $ms->panel_deluxe_ms }};
