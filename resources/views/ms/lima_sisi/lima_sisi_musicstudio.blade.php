...
<head>
    ...
    <script>
        function PenawaranLimaSisiMsGs() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_gs";
        }

        function PenawaranLimaSisiMsGm() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_gm";
        }

        function PenawaranLimaSisiMsGh() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_gh";
        }

        function PenawaranLimaSisiMsAs() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_as";
        }

        function PenawaranLimaSisiMsAm() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_am";
        }

        function PenawaranLimaSisiMsAh() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_ah";
        }

        function PenawaranLimaSisiMsAd() {
            document.forms['perhitungan'].action = "/ms_penawaran_ls_ad";
        }
    </script>
</head>
...
<body>
    <form class="form-horizontal" action="" method="GET" name="perhitungan">
        <center>
            <img src="images/5sisi.png" alt="" style="width: 200px; height: 150px;">
        </center>
        <div class="row">
            <div class="col">
                                                ...
                                                <ul class="nav nav-pills nav-fill rounded" id="myTab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="high-gypsum-tab"
                                                            ...
                                                            type="button" role="tab"
                                                            aria-controls="highGypusm" aria-selected="false">High
                                                            Quality</button>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranLimaSisiMsAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
    ...
    <script>
        ...
        function calc() {
            ...
            document.getElementById('Ldinding').innerText = parseFloat(parseFloat(parseFloat(dindingSatu) + parseFloat(
                dindingDua) + parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalGSbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $ms->gypsum_standard_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalGSbarangDANpemasangan').innerText = formatRupiah(((parseFloat(parseFloat(
                ...
                (parseFloat(parseFloat(dindingSatu) + parseFloat(
                    dindingDua) + parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(
                    dindingLima))).toFixed(2) * {{ $jasaPeredam->jasa_peredam_plafon }}) + (parseInt(
                jmlPintu) * {{ $pintuPeredam->jasa_pasang_pintu }})));
            ...
            document.getElementById('totalGMbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $ms->gypsum_medium_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalGHbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $ms->gypsum_high_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                2) * {{ $ms->gypsum_high_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            ...
            document.getElementById('totalASbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                        ...
                        dindingEmpat) +
                    parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                {{ $ms->panel_standard_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
            ...
            document.getElementById('totalASbarangDANpemasangan').innerText = formatRupiah(((parseFloat(parseFloat(
                ...
                document.getElementById('totalAMbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $ms->panel_medium_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                ...
                document.getElementById('totalAHbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $ms->panel_high_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
                    2) * {{ $ms->panel_high_ms }}) + (
                    parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
                ...
                document.getElementById('totalADbarang').innerText = formatRupiah((parseFloat(parseFloat(parseFloat(
                            ...
                            dindingEmpat) +
                        parseFloat(dindingLima)).toFixed(2) * parseFloat(tinggi)).toFixed(2) *
                    {{ $ms->panel_deluxe_ms }}) + (parseFloat(parseFloat(dindingSatu) + parseFloat(dindingDua) +
                    parseFloat(dindingTiga) + parseFloat(dindingEmpat) + parseFloat(dindingLima)).toFixed(
