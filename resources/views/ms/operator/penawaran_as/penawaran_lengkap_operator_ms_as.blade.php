...
<head>
    ...
    <title>Penawaran {{ $p_o_ms->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_o_ms->nama }} <br>Lokasi :
                                        {{ $p_o_ms->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_o_ms->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_o_ms->foto1) }}"
                                                alt="{{ $p_o_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_o_ms->foto2) }}"
                                                alt="{{ $p_o_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_o_ms->foto3) }}"
                                                alt="{{ $p_o_ms->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr class="text-end">
                            <th colspan="6">
                                Panjang Studio : <span id="panjangStudioPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_o_ms->panjangStudio }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Lebar Studio : <span id="lebarStudioPrint" style="display: none;"></span><input type="number"
                                    ...
                                    value="{{ $p_o_ms->lebarStudio }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                                Panjang Operator : <span id="panjangOperatorPrint" style="display: none;"></span><input
                                    ...
                                    value="{{ $p_o_ms->panjangOperator }}" onFocus="startCalc();" onBlur="stopCalc();"
                                    step="0.1" required>
                                &nbsp;&nbsp;||&nbsp;&nbsp;
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_o_ms->pintu }}"
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $panjang;
                            if ($p_o_ms->panjangStudio < 3) {
                                $panjang = 1;
                            } elseif ($p_o_ms->panjangStudio > 2.9 and $p_o_ms->panjangStudio < 5.1) {
                                $panjang = 2;
                            } elseif ($p_o_ms->panjangStudio > 5 and $p_o_ms->panjangStudio < 7.1) {
                                $panjang = 3;
                            } elseif ($p_o_ms->panjangStudio > 7 and $p_o_ms->panjangStudio < 9.1) {
                                $panjang = 4;
                            } elseif ($p_o_ms->panjangStudio > 9 and $p_o_ms->panjangStudio < 11.1) {
                                $panjang = 5;
                            } elseif ($p_o_ms->panjangStudio > 11 and $p_o_ms->panjangStudio < 13.1) {
                                $panjang = 6;
                            } elseif ($p_o_ms->panjangStudio > 13 and $p_o_ms->panjangStudio < 15.1) {
                                $panjang = 7;
                            } elseif ($p_o_ms->panjangStudio > 15 and $p_o_ms->panjangStudio < 17.1) {
                                $panjang = 8;
                            } elseif ($p_o_ms->panjangStudio > 17 and $p_o_ms->panjangStudio < 19.1) {
                                $panjang = 9;
                            } elseif ($p_o_ms->panjangStudio > 19 and $p_o_ms->panjangStudio < 21.1) {
                                $panjang = 10;
                            } else {
                                $panjang = 11;
                            }
                            ...
                            $lebar;
                            if (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 3) {
                                $lebar = 1;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 2.9 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 5.1) {
                                $lebar = 2;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 5 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 7.1) {
                                $lebar = 3;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 7 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 9.1) {
                                $lebar = 4;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 9 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 11.1) {
                                $lebar = 5;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 11 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 13.1) {
                                $lebar = 6;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 13 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 15.1) {
                                $lebar = 7;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 15 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 17.1) {
                                $lebar = 8;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 17 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 19.1) {
                                $lebar = 9;
                            } elseif (($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) > 19 and ($p_o_ms->lebarStudio) + ($p_o_ms->lebarOperator) < 21.1) {
                                $lebar = 10;
                            } else {
                                $lebar = 11;
                            }
