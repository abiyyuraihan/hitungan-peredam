    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/kr_penawaran_es_as@store"
                    ...
                    <tr style="background-color: rgb(233, 231, 231);">
                        <?php
                        $panjang = $_GET['panjang'] / 100;
                        $lebar = $_GET['lebar'] / 100;
                        $tinggi = $_GET['tinggi'] / 100;
                        ?>
                        <th hidden>Panjang :<input type="text" value="<?= $panjang ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="panjang"
                                readonly hidden></th>
                        <th hidden>Lebar :<input type="text" value="<?= $lebar ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="lebar"
                                readonly hidden></th>
                        <th hidden>Tinggi :<input type="text" value="<?= $tinggi ?>"
                                style="border: none; width:25px; font-size: 12px; font-weight: bold;" name="tinggi"
                                readonly hidden></th>
                        <th colspan="6">Panjang : <?= $panjang ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;&nbsp;
                            Lebar : <?= $lebar ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;&nbsp; Tinggi : <?= $tinggi ?></th>
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td class="text-center">
                            <?= 2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) ?>
                        </td>
                        <td class="text-end">@currency($kr->panel_standard_kr)</td>
                        <td id="jumlahPeredamDinding" hidden>
                            <?= 2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $kr->panel_standard_kr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $kr->panel_standard_kr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td class="text-center"><?= ($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) ?></td>
                        <td class="text-end">@currency($kr->panel_standard_kr)</td>
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= ($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $kr->panel_standard_kr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $kr->panel_standard_kr, 0, ',', '.') ?>
                        </td>
                    </tr>
                    ...
                    <tr id="activePemasanganDinding"
                        ...
                        <td id="jumlahPemasanganDinding" hidden>
                            <?= 2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $jasaPeredam->jasa_peredam_dinding ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $jasaPeredam->jasa_peredam_dinding, 0, ',', '.') ?>
                        </td>
                    </tr>
                    <tr id="activePemasanganPlafon"
                        ...
                        <td class="text-center">
                            <?= ($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) ?></td>
                        <td class="text-end">@currency($jasaPeredam->jasa_peredam_plafon)</td>
                        <td id="jumlahPemasanganPlafon" hidden>
                            <?= ($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $jasaPeredam->jasa_peredam_plafon ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $jasaPeredam->jasa_peredam_plafon, 0, ',', '.') ?>
                        </td>
                    </tr>
                    ...
                    <tr id="listrikActive" style="display: none; background-color: rgb(255, 246, 215);">
                        ...
                        <td hidden><?php
                        $panjang;
                        if ($_GET['panjang'] / 100 < 3) {
                            $panjang = 1;
                        } elseif ($_GET['panjang'] / 100 > 2.9 and $_GET['panjang'] / 100 < 5.1) {
                            $panjang = 2;
                        } elseif ($_GET['panjang'] / 100 > 5 and $_GET['panjang'] / 100 < 7.1) {
                            $panjang = 3;
                        } elseif ($_GET['panjang'] / 100 > 7 and $_GET['panjang'] / 100 < 9.1) {
                            $panjang = 4;
                        } elseif ($_GET['panjang'] / 100 > 9 and $_GET['panjang'] / 100 < 11.1) {
                            $panjang = 5;
                        } elseif ($_GET['panjang'] / 100 > 11 and $_GET['panjang'] / 100 < 13.1) {
                            $panjang = 6;
                        } elseif ($_GET['panjang'] / 100 > 13 and $_GET['panjang'] / 100 < 15.1) {
                            $panjang = 7;
                        } elseif ($_GET['panjang'] / 100 > 15 and $_GET['panjang'] / 100 < 17.1) {
                            $panjang = 8;
                        } elseif ($_GET['panjang'] / 100 > 17 and $_GET['panjang'] / 100 < 19.1) {
                            $panjang = 9;
                        } elseif ($_GET['panjang'] / 100 > 19 and $_GET['panjang'] / 100 < 21.1) {
                            $panjang = 10;
                        } else {
                            $panjang = 11;
                        }
                        ...
                        if ($_GET['lebar'] / 100 < 3) {
                            $lebar = 1;
                        } elseif ($_GET['lebar'] / 100 > 2.9 and $_GET['lebar'] / 100 < 5.1) {
                            $lebar = 2;
                        } elseif ($_GET['lebar'] / 100 > 5 and $_GET['lebar'] / 100 < 7.1) {
                            $lebar = 3;
                        } elseif ($_GET['lebar'] / 100 > 7 and $_GET['lebar'] / 100 < 9.1) {
                            $lebar = 4;
                        } elseif ($_GET['lebar'] / 100 > 9 and $_GET['lebar'] / 100 < 11.1) {
                            $lebar = 5;
                        } elseif ($_GET['lebar'] / 100 > 11 and $_GET['lebar'] / 100 < 13.1) {
                            $lebar = 6;
                        } elseif ($_GET['lebar'] / 100 > 13 and $_GET['lebar'] / 100 < 15.1) {
                            $lebar = 7;
                        } elseif ($_GET['lebar'] / 100 > 15 and $_GET['lebar'] / 100 < 17.1) {
                            $lebar = 8;
                        } elseif ($_GET['lebar'] / 100 > 17 and $_GET['lebar'] / 100 < 19.1) {
                            $lebar = 9;
                        } elseif ($_GET['lebar'] / 100 > 19 and $_GET['lebar'] / 100 < 21.1) {
                            $lebar = 10;
                        } else {
                            $lebar = 11;
                        }
