    ...
    <div class="container g-0" style="width: 98%;">
        <div class="col" style="font-size: 12px; width: 100%;">
            <table class="table table-bordered border-dark" id="printArea">
                <form id="formPenawaran" method="post" action="/gr_penawaran_es_ah@store"
                    ...
                    <tr style="background-color: rgb(255, 246, 215);">
                        ...
                        <td id="jumlahPeredamDinding" hidden>
                            <?= 2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $gr->panel_high_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(2 * ($_GET['panjang'] / 100 + $_GET['lebar'] / 100) * ($_GET['tinggi'] / 100) * $gr->panel_high_gr, 0, ',', '.') ?>
                        </td>
                    ...
                    <tr style="background-color: rgb(252, 234, 168);">
                        ...
                        <td id="jumlahPeredamPlafon" hidden>
                            <?= ($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $gr->panel_high_gr ?>
                        </td>
                        <td class="text-end">
                            <?= number_format(($_GET['panjang'] / 100) * ($_GET['lebar'] / 100) * $gr->panel_high_gr, 0, ',', '.') ?>
                        </td>
                    </tr>
