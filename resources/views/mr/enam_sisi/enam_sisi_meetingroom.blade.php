...
<head>
    ...
    <script>
        function PenawaranEnamSisiMrGs() {
            document.forms['perhitungan'].action = "/mr_penawaran_ens_gs";
        }

        function PenawaranEnamSisiMrGm() {
            document.forms['perhitungan'].action = "/mr_penawaran_ens_gm";
        }

        function PenawaranEnamSisiMrAs() {
            document.forms['perhitungan'].action = "/mr_penawaran_ens_as";
        }

        function PenawaranEnamSisiMrAm() {
            document.forms['perhitungan'].action = "/mr_penawaran_ens_am";
        }

        function PenawaranEnamSisiMrAh() {
            document.forms['perhitungan'].action = "/mr_penawaran_ens_ah";
        }
    </script>
</head>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranEnamSisiMrAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
