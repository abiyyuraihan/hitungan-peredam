...
<head>
    ...
    <script>
        function PenawaranOperatorEntranceMsGs() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_gs";
        }

        function PenawaranOperatorEntranceMsGm() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_gm";
        }

        function PenawaranOperatorEntranceMsGh() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_gh";
        }

        function PenawaranOperatorEntranceMsAs() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_as";
        }

        function PenawaranOperatorEntranceMsAm() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_am";
        }

        function PenawaranOperatorEntranceMsAh() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_ah";
        }

        function PenawaranOperatorEntranceMsAd() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_e_ad";
        }
    </script>
</head>
...
<body>
    <form class="form-horizontal" action="" method="GET" name="perhitungan">
        <center class="mt-2">
            <img src="images/operator_entrance.png" alt="" style="width: 200px; height: 150px;">
        </center>
        <div class="row mt-3">
            <div class="col">
                <div class="container pb-2 g-3" style="background-color: #064663; ">
                    <div class="row">
                        <div class="col" style="margin-left: -12px;">
                            ...
                            <div class="row g-2">
                                <div class="col">
                                    <label for="" class="mb-1 text-warning" style="font-size: 9px;">Panjang
                                        Studio
                                        (cm)</label>
                                    <input type="number" name="panjangStudio" id="panjangStudio" class="form-control"
                                        value="0" onFocus="startCalc();" onBlur="stopCalc();" required
                                        style="height : 25px">
                                </div>
                                <div class="col">
                                    <label for="" class="mb-1 text-warning" style="font-size: 9px;">Lebar
                                        Studio
                                        (cm)</label>
                                    <input type="number" name="lebarStudio" id="lebarStudio" class="form-control"
                                        value="0" onFocus="startCalc();" onBlur="stopCalc();" required
                                        style="height : 25px">
                                </div>
                            </div>
                            ...
                            <div class="row g-2">
                                <div class="col">
                                    <label for="" class="mb-1 text-warning" style="font-size: 9px;">Panjang Ruang Operator
                                        (cm)</label>
                                    <input type="number" name="panjangOperator" id="panjangOperator"
                                        class="form-control" value="0" onFocus="startCalc();" onBlur="stopCalc();"
                                        required style="height : 25px">
                                </div>
                                <div class="col">
                                    <label for="" class="mb-1 text-warning" style="font-size: 9px;">Lebar Ruang Operator
                                        (cm)</label>
                                    <input type="number" name="lebarOperator" id="lebarOperator" class="form-control"
                                        value="0" onFocus="startCalc();" onBlur="stopCalc();" required
                                        style="height : 25px">
                                </div>
                            </div>
                                                ...
                                                <ul class="nav nav-pills nav-fill rounded" id="myTab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="high-gypsum-tab"
                                                            ...
                                                            type="button" role="tab" aria-controls="highGypusm"
                                                            aria-selected="false">High
                                                            Quality</button>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardGypsum"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranOperatorEntranceMsGs()"
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="highGypsum"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranOperatorEntranceMsGh()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                ...
                                                <ul class="nav nav-pills nav-fill rounded" id="myTab"
                                                    ...
                                                    <li class="nav-item" role="presentation">
                                                        <button class="nav-link" id="deluxe-akustik-tab"
                                                            ...
                                                            type="button" role="tab"
                                                            aria-controls="deluxeAkustik" aria-selected="false">Deluxe
                                                            Quality</button>
                                                    </li>
                                                </ul>
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranOperatorEntranceMsAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="mediumAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranOperatorEntranceMsAm()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="highAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranOperatorEntranceMsAh()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade show p-2" id="deluxeAkustik"
                                                        ...
                                                        <center><input class="mt-2 pb-1 rounded-pill" type="submit"
                                                                onclick="PenawaranOperatorEntranceMsAd()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
    ...
    <script>
        ...
        function calc() {
            ...
            panjangStudio = document.perhitungan.panjangStudio.value / 100;
            lebarStudio = document.perhitungan.lebarStudio.value / 100;
            panjangOperator = document.perhitungan.panjangOperator.value / 100;
            lebarOperator = document.perhitungan.lebarOperator.value / 100;
            tinggi = document.perhitungan.tinggi.value / 100;
            jmlPintu = document.perhitungan.pintu.value;

            //Perhitungan
            document.getElementById('Ldinding').innerText = parseFloat((2 * (parseFloat(panjangStudio) + parseFloat(
                    lebarStudio)) *
                parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) + parseFloat(lebarOperator)) *
                parseFloat(tinggi))).toFixed(2) + " m2";
            document.getElementById('Lplafon').innerText = parseFloat((parseFloat(panjangStudio) * parseFloat(
                lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(
                2) + " m2";
            document.getElementById('jmlPintu').innerText = parseInt(jmlPintu) + " pcs";

            //Gypsum Standard
            document.getElementById('totalGSbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->gypsum_standard_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalGSpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
                (parseFloat((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) *
                    parseFloat(lebarOperator))).toFixed(2)) * {{ $jasaPeredam->jasa_peredam_plafon }}) + (parseInt(
            ...
            document.getElementById('totalGSbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                    panjangStudio) + parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(
                    panjangOperator) + parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + ((parseFloat((
                    parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (
                    parseFloat(panjangOperator) * parseFloat(lebarOperator))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_plafon }})) + ((parseFloat((((2 * (parseFloat(
                panjangStudio) + parseFloat(lebarStudio))) + (2 * (parseFloat(
                panjangOperator) + parseFloat(lebarOperator)))) * parseFloat(tinggi)) + ((parseFloat(
                    panjangStudio) *
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->gypsum_standard_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Gypsum Medium
            document.getElementById('totalGMbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->gypsum_medium_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalGMpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalGMbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->gypsum_medium_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Gypsum High
            document.getElementById('totalGHbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->gypsum_high_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalGHpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalGHbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                    panjangStudio) + parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(
                    panjangOperator) + parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + ((parseFloat((
                    parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->gypsum_high_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Panel Akustik Standard
            document.getElementById('totalASbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->panel_standard_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalASpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalASbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->panel_standard_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Panel Akustik Medium
            document.getElementById('totalAMbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->panel_medium_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalAMpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalAMbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->panel_medium_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Panel Akustik High
            document.getElementById('totalAHbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->panel_high_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalAHpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalAHbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->panel_high_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));

            //Panel Akustik Deluxe
            document.getElementById('totalADbarang').innerText = formatRupiah((parseFloat((((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio))) * parseFloat(tinggi)) + ((2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator))) * parseFloat(tinggi))) + ((parseFloat(panjangStudio) *
                    parseFloat(lebarStudio)) + (parseFloat(panjangOperator) * parseFloat(lebarOperator)))) *
                {{ $ms->panel_deluxe_ms }}) + (
                parseInt(jmlPintu) * ((81 * 210) * {{ $pintuPeredam->tebal_4cm }})));
            document.getElementById('totalADpemasangan').innerText = formatRupiah(((parseFloat((2 * (parseFloat(
                        panjangStudio) +
                    parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(panjangOperator) +
                    parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + (
            ...
            document.getElementById('totalADbarangDANpemasangan').innerText = formatRupiah((((parseFloat((2 * (parseFloat(
                    panjangStudio) + parseFloat(lebarStudio)) * parseFloat(tinggi)) + (2 * (parseFloat(
                    panjangOperator) + parseFloat(lebarOperator)) * parseFloat(tinggi))).toFixed(2)) *
                {{ $jasaPeredam->jasa_peredam_dinding }}) + ((parseFloat((
                    parseFloat(panjangStudio) * parseFloat(lebarStudio)) + (
                ...
                parseFloat(lebarStudio)) + (parseFloat(
                    panjangOperator) *
                parseFloat(lebarOperator)))) * {{ $ms->panel_deluxe_ms }}) + ((parseInt(jmlPintu) * ((81 *
                    210) *
                {{ $pintuPeredam->tebal_4cm }})) + (parseInt(jmlPintu) *
                {{ $pintuPeredam->jasa_pasang_pintu }}))));
