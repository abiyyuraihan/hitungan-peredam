...
<head>
    ...
    <title>Penawaran {{ $p_es_gr->nama }}</title>
                    ...
                    <form id="formPenawaran" action="" method="post" enctype="multipart/form-data"
                        ...
                        <tr>
                            <th colspan="6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col">Nama &nbsp;: {{ $p_es_gr->nama }} <br>Lokasi :
                                        {{ $p_es_gr->alamat }}</div>
                                    <div class="col">
                                        <p class="text-end">Depok, {{ $p_es_gr->updated_at->format('m/d/Y') }}</p>
                                    </div>
                                </div>
                                <center>
                                    <div class="row">
                                ...
                                <div>
                                    ...
                                    <div class="row g-0 m-0">
                                        <div class="col">
                                            <img src="{{ asset('storage/' . $p_es_gr->foto1) }}"
                                                alt="{{ $p_es_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_es_gr->foto2) }}"
                                                alt="{{ $p_es_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                            <img src="{{ asset('storage/' . $p_es_gr->foto3) }}"
                                                alt="{{ $p_es_gr->nama }}" height="100px" onclick="onClick(this)"
                                                style="cursor:pointer" class="w3-hover-opacity">
                                        </div>
                                    </div>
                        ...
                        <tr>
                            <td colspan="3"><big><b>Spesifikasi : </b><br><br>1. Mdf Hijau (HMR) <br>2.
                                Rockwool Density 60kg/m3 <br>3. Pe Foam & Yellow Foam<br>4. Finishing Fabric Layer</big></td>
                            <td colspan="3"></td>
                        </tr>
                        <tr>
                        ...
                        <tr id="activePintuPeredam">
                            ...
                            <td class="text-center"><span id="pintuPrint" style="display: none;"></span><input
                                    type="number" value="{{ $p_es_gr->pintu }}"
                        ...
                        <tr id="listrikActive">
                            ...
                            <td hidden><?php
                            $panjang;
                            if ($p_es_gr->panjang < 3) {
                                $panjang = 1;
                            } elseif ($p_es_gr->panjang > 2.9 and $p_es_gr->panjang < 5.1) {
                                $panjang = 2;
                            } elseif ($p_es_gr->panjang > 5 and $p_es_gr->panjang < 7.1) {
                                $panjang = 3;
                            } elseif ($p_es_gr->panjang > 7 and $p_es_gr->panjang < 9.1) {
                                $panjang = 4;
                            } elseif ($p_es_gr->panjang > 9 and $p_es_gr->panjang < 11.1) {
                                $panjang = 5;
                            } elseif ($p_es_gr->panjang > 11 and $p_es_gr->panjang < 13.1) {
                                $panjang = 6;
                            } elseif ($p_es_gr->panjang > 13 and $p_es_gr->panjang < 15.1) {
                                $panjang = 7;
                            } elseif ($p_es_gr->panjang > 15 and $p_es_gr->panjang < 17.1) {
                                $panjang = 8;
                            } elseif ($p_es_gr->panjang > 17 and $p_es_gr->panjang < 19.1) {
                                $panjang = 9;
                            } elseif ($p_es_gr->panjang > 19 and $p_es_gr->panjang < 21.1) {
                                $panjang = 10;
                            } else {
                                $panjang = 11;
                            }
                            ...
                            if ($p_es_gr->lebar < 3) {
                                $lebar = 1;
                            } elseif ($p_es_gr->lebar > 2.9 and $p_es_gr->lebar < 5.1) {
                                $lebar = 2;
                            } elseif ($p_es_gr->lebar > 5 and $p_es_gr->lebar < 7.1) {
                                $lebar = 3;
                            } elseif ($p_es_gr->lebar > 7 and $p_es_gr->lebar < 9.1) {
                                $lebar = 4;
                            } elseif ($p_es_gr->lebar > 9 and $p_es_gr->lebar < 11.1) {
                                $lebar = 5;
                            } elseif ($p_es_gr->lebar > 11 and $p_es_gr->lebar < 13.1) {
                                $lebar = 6;
                            } elseif ($p_es_gr->lebar > 13 and $p_es_gr->lebar < 15.1) {
                                $lebar = 7;
                            } elseif ($p_es_gr->lebar > 15 and $p_es_gr->lebar < 17.1) {
                                $lebar = 8;
                            } elseif ($p_es_gr->lebar > 17 and $p_es_gr->lebar < 19.1) {
                                $lebar = 9;
                            } elseif ($p_es_gr->lebar > 19 and $p_es_gr->lebar < 21.1) {
                                $lebar = 10;
                            } else {
                                $lebar = 11;
                            }
...
<script>
    ...
    function calc() {
        ...
        document.getElementById('jumlahPeredamDinding').innerText = (parseFloat(2 * (parseFloat(
                panjang) + parseFloat(
                lebar)) *
            parseFloat(tinggi)).toFixed(2)) * {{ $gr->panel_standard_gr }};
        ...
        document.getElementById('jumlahPeredamPlafon').innerText = (parseFloat(parseFloat(panjang) * parseFloat(lebar))
            .toFixed(2)) * {{ $gr->panel_standard_gr }};
