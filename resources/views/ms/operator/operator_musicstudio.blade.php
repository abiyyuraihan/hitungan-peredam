...
<head>
    ...
    <script>
        function PenawaranOperatorMsGs() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_gs";
        }

        function PenawaranOperatorMsGm() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_gm";
        }

        function PenawaranOperatorMsGh() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_gh";
        }

        function PenawaranOperatorMsAs() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_as";
        }

        function PenawaranOperatorMsAm() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_am";
        }

        function PenawaranOperatorMsAh() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_ah";
        }

        function PenawaranOperatorMsAd() {
            document.forms['perhitungan'].action = "/ms_penawaran_o_ad";
        }
    </script>
</head>
...
<body>
    <form class="form-horizontal" action="" method="GET" name="perhitungan">
        <center class="mt-2">
            <img src="images/operator.png" alt="" style="width: 200px; height: 150px;">
        </center>
        <div class="row mt-3">
            <div class="col">
                                                ...
                                                <div class="tab-content mt-2 rounded pr-4 justify-content-center"
                                                    ...
                                                    <div class="tab-pane fade show active p-2" id="standardAkustik"
                                                        ...
                                                        <center><input class="button mt-2 pb-1 rounded-pill"
                                                                type="submit" onclick="PenawaranOperatorMsAs()"
                                                                value="Lanjut Penawaran"
                                                                style="font-weight: bold; color: #cecccc; background-color:#064663; border: none; width: 200px; height: 40px;">
                                                        </center>
                                                    </div>
